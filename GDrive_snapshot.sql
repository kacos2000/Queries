...
case when local_entry.volume = volume_info.volume then volume_info.full_path||"  - Volume Name: ("||volume_info.label||")" else local_entry.volume end as 'Volume',
